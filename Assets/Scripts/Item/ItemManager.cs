...
public class ItemManager : MonoBehaviour 
{
  ...
  private void BuyingItem(ItemStatus data, GameObject items)
  {
    ...
    GameObject dialogBox = DialogBoxManager.GetInstance ().GenerateDialogBox ("Are you sure to buy this item ?", true);
  ...
  private void SellingItem(Item item, GameObject items)
  {
    ...
    GameObject dialogBox = DialogBoxManager.GetInstance ().GenerateDialogBox ("Are you sure to sell this item ?", true);
